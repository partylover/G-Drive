...
xst -ifn xst.scr
move core_clk_man_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\core_clk_man_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc core_clk_man_exdes.ucf core_clk_man_exdes

echo 'Running map'
map -timing -pr b core_clk_man_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm core_clk_man_exdes -w routed.ncd routed.v
cd ..
