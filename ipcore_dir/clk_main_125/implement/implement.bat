...
xst -ifn xst.scr
copy clk_main_125_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\clk_main_125.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clk_main_125.ucf clk_main_125_exdes

echo 'Running map'
map -timing -pr b clk_main_125_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -tm clk_main_125_exdes -w routed.ncd routed.v
cd ..
